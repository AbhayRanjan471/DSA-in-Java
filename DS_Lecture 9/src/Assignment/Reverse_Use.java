...
public class Reverse_Use {
	...
	public static void main(String[] args) {
		...
		for(int i = 0 ; i< 5 ; i++) {
			stack.push(i); // we are calling the push function of inbuild Stack class
		...
		//class name . function name();
		    ...
		    // OR (we can create object the Reverse_a_Stack class and the call its function as we have done below)
//		Reverse_a_Stack p = new Reverse_a_Stack();
//		p.reverseStack(stack, empty);
